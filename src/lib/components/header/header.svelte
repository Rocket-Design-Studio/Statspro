...
<header>
	<div class="menu">
		<div class="left">
			<ul>
				<li><a href="/">HOME</a></li>
				<li><a href="/products_and_services">PRODUCTS AND SERVICES</a></li>
				<li><a href="/visual_cvs">VISUAL CV'S</a></li>
		...
		<div class="right">
			<a href="https://www.playpro.co.za/">LOGIN |REGISTER</a>
		</div>
	</div>
...
<div class="mobile-full-menu">
    ...
    <ul>
        ...
        <li><a href="/about_us">ABOUT US</a></li>
        <li><a href="/contact_us">CONTACT US</a></li>
        <li><a href="https://www.playpro.co.za/">LOGIN |REGISTER</a></li>
    </ul>
</div>
{/if}